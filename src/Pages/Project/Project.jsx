...
function Scene({ top, mouse }) {
  ...
  return (
    <>
      ...
      <Background color={top.interpolate([0, scrollMax * 0.25, scrollMax * 0.8, scrollMax], ['#27282F', '#247BA0', '#70C1B3', '#f8f3f1','#1813f1'])} />
      ...
      <Text position={top.interpolate(top => [0, -5 + ((top * 10) / scrollMax) * 2, 0])} color="black" fontSize={150}>
        Ipsum
      </Text>
...
export default function Projects() {
  ...
  return (
    <>
     <div style={{ height: '100vh' , width:'100%'}} onScroll={onScroll} onMouseMove={onMouseMove}>
